 ...
 */
package de.unidue.ltl.LREC2018.dynet;
...
public class DynetSeq2SeqTrainTest implements Constants {
	...
	static String dyNetUserCode = null;

	/**
	 * Runs the DyNet demo. The demo is runnable as-is and uses a small subset of
	 ...
	 * which DyNet is installed. This demo will crash if DyNet is not found
	...
	public static void main(String[] args) throws Exception {
		...
		dyNetUserCode = p.getProperty("userCode").trim();
